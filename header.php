		...
		<div id="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="inner-header" class="grid-container">
					...
					<?php // display the contact phone number from the theme settings page ?>
					<div id="contact-call-to-action" class="grid-50"><?php echo get_theme_mod( 'tcx_telephone_number_text' ); ?></div>
					...
					<nav role="navigation" class="main-menu" itemscope itemtype="http://schema.org/SiteNavigationElement">
						<?php wp_nav_menu(array(
    					         ...
    					         'menu' => __( 'The Main Menu', 'roughdraft' ),  // nav name
